...
import FWD_Development.DocuView.controllers.api.v1.FiltersV1;
...
public class FiltersV1Test {

    @Autowired
    private FiltersV1 controller;
    ...
    void apiLoadDownload() throws Exception {
        this.mockMvc
            .perform(get("/api/v1/filters").header("Authorization", token))
